...
delete_rt_smart_name_list="\
kernel/bsp/maix3/build \
kernel/bsp/maix3/rtthread.bin \
kernel/bsp/maix3/rtthread.elf \
kernel/bsp/maix3/rtthread.map \
kernel/bsp/maix3/board/mpp/lib/*.a \
kernel/bsp/maix3/board/ipcm/lib/*.a \
userapps/root \
userapps/testcases"
...
(   
	...
	rm -rf ${RELEASE_MPP_SRC_DIR}/userapps/sample/fastboot_app/CMakeCache.txt;
	rm -rf ${RELEASE_MPP_SRC_DIR}/userapps/sample/fastboot_app/CMakeFiles;
	rm -rf ${RELEASE_MPP_SRC_DIR}/userapps/sample/fastboot_app/cmake_install.cmake;
	rm -rf ${RELEASE_MPP_SRC_DIR}/userapps/sample/fastboot_app/fastboot_app.elf;
	rm -rf ${RELEASE_MPP_SRC_DIR}/userapps/sample/fastboot_app/install_manifest.txt;
	rm -rf ${RELEASE_MPP_SRC_DIR}/userapps/sample/fastboot_app/Makefile;
)
...
#	cd ${RELEASE_CDK_SRC_DIR}/kernel/ipcm;
#	shopt -s extglob
#	rm -rf ${open_cdk_kernel_name_list};
#	shopt -u extglob
...
#rt-smart
(   set -e ;
    cd ${RELEASE_RT_SMART_SRC_PATH};
	rm -rf ${delete_rt_smart_name_list};
)
...
rm -rf .config defconfig Makefile_release; mv Makefile_github  Makefile
rm -rf README.md README_release.md; mv README_github.md  README.md
make mpp-clean
make cdk-user-clean
