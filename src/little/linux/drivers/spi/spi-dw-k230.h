...
extern void k230_dw_spi_set_cs(struct spi_device *spi, bool enable);
extern void k230_dw_spi_update_config(struct dw_spi *dws, struct spi_device *spi,
				 struct dw_spi_cfg *cfg);
extern int k230_dw_spi_check_status(struct dw_spi *dws, bool raw);
extern int k230_dw_spi_add_host(struct device *dev, struct dw_spi *dws);
extern void k230_dw_spi_remove_host(struct dw_spi *dws);
extern int k230_dw_spi_suspend_host(struct dw_spi *dws);
extern int k230_dw_spi_resume_host(struct dw_spi *dws);

#ifdef CONFIG_SPI_DW_DMA

extern void k230_dw_spi_dma_setup_mfld(struct dw_spi *dws);
extern void k230_dw_spi_dma_setup_generic(struct dw_spi *dws);

#else

static inline void k230_dw_spi_dma_setup_mfld(struct dw_spi *dws) {}
static inline void k230_dw_spi_dma_setup_generic(struct dw_spi *dws) {}
