...
#define oam_info_log0(fmt) \
    oal_print_nlogs(aich_strrchr(__FILE__, '/'), __FUNCTION__, (td_u16)__LINE__, OAL_RET_ADDR, \
        OAM_LOG_LEVEL_INFO, 0, (fmt), 0, 0, 0, 0)
#define oam_info_log1(fmt, p1) \
    oal_print_nlogs(aich_strrchr(__FILE__, '/'), __FUNCTION__, (td_u16)__LINE__, OAL_RET_ADDR, \
        OAM_LOG_LEVEL_INFO, 1, (fmt), (td_u32)(p1), 0, 0, 0)
#define oam_info_log2(fmt, p1, p2) \
    oal_print_nlogs(aich_strrchr(__FILE__, '/'), __FUNCTION__, (td_u16)__LINE__, OAL_RET_ADDR, \
        OAM_LOG_LEVEL_INFO, 2, (fmt), (td_u32)(p1), (td_u32)(p2), 0, 0)
#define oam_info_log3(fmt, p1, p2, p3) \
    oal_print_nlogs(aich_strrchr(__FILE__, '/'), __FUNCTION__, (td_u16)__LINE__, OAL_RET_ADDR, \
        OAM_LOG_LEVEL_INFO, 3, (fmt), (td_u32)(p1), (td_u32)(p2), (td_u32)(p3), 0)
#define oam_info_log4(fmt, p1, p2, p3, p4) \
    oal_print_nlogs(aich_strrchr(__FILE__, '/'), __FUNCTION__, (td_u16)__LINE__, OAL_RET_ADDR, \
        OAM_LOG_LEVEL_INFO, 4, (fmt), (td_u32)(p1), (td_u32)(p2), (td_u32)(p3), \
            (td_u32)(p4))
...
#define oam_warning_log1(fmt, p1)               \
    oal_print_nlogs(aich_strrchr(__FILE__, '/'), __FUNCTION__, (td_u16)__LINE__, OAL_RET_ADDR, \
        OAM_LOG_LEVEL_WARNING, 1, (fmt), (td_u32)(p1), 0, 0, 0)
#define oam_warning_log2(fmt, p1, p2)           \
    oal_print_nlogs(aich_strrchr(__FILE__, '/'), __FUNCTION__, (td_u16)__LINE__, OAL_RET_ADDR, \
        OAM_LOG_LEVEL_WARNING, 2, (fmt), (td_u32)(p1), (td_u32)(p2), 0, 0)
#define oam_warning_log3(fmt, p1, p2, p3)       \
    oal_print_nlogs(aich_strrchr(__FILE__, '/'), __FUNCTION__, (td_u16)__LINE__, OAL_RET_ADDR, \
        OAM_LOG_LEVEL_WARNING, 3, (fmt), (td_u32)(p1), (td_u32)(p2), (td_u32)(p3), 0)
#define oam_warning_log4(fmt, p1, p2, p3, p4)   \
    oal_print_nlogs(aich_strrchr(__FILE__, '/'), __FUNCTION__, (td_u16)__LINE__, OAL_RET_ADDR, \
        OAM_LOG_LEVEL_WARNING, 4, (fmt), (td_u32)(p1), (td_u32)(p2), (td_u32)(p3), \
            (td_u32)(p4))
...
#define oam_error_log1(fmt, p1)                 \
    oal_print_nlogs(aich_strrchr(__FILE__, '/'), __FUNCTION__, (td_u16)__LINE__, OAL_RET_ADDR, \
        OAM_LOG_LEVEL_ERROR, 1, (fmt), (td_u64)(p1), 0, 0, 0)
#define oam_error_log2(fmt, p1, p2)             \
    oal_print_nlogs(aich_strrchr(__FILE__, '/'), __FUNCTION__, (td_u16)__LINE__, OAL_RET_ADDR, \
        OAM_LOG_LEVEL_ERROR, 2, (fmt), (td_u64)(p1), (td_u64)(p2), 0, 0)
#define oam_error_log3(fmt, p1, p2, p3)         \
    oal_print_nlogs(aich_strrchr(__FILE__, '/'), __FUNCTION__, (td_u16)__LINE__, OAL_RET_ADDR, \
        OAM_LOG_LEVEL_ERROR, 3, (fmt), (td_u64)(p1), (td_u64)(p2), (td_u64)(p3), 0)
#define oam_error_log4(fmt, p1, p2, p3, p4)     \
    oal_print_nlogs(aich_strrchr(__FILE__, '/'), __FUNCTION__, (td_u16)__LINE__, OAL_RET_ADDR, \
        OAM_LOG_LEVEL_ERROR, 4, (fmt), (td_u64)(p1), (td_u64)(p2), (td_u64)(p3), \
            (td_u64)(p4))

#define EXT_DIAG_PRINTF dprintf
...
typedef td_u8 oam_log_level_enum_uint8;
