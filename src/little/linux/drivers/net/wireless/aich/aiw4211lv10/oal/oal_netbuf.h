...
#else
#define oal_host2net_short(_x)      aich_swap_byteorder_16(_x)
#define oal_net2host_short(_x)      aich_swap_byteorder_16(_x)
#define oal_host2net_long(_x)       aich_swap_byteorder_32(_x)
#define oal_net2host_long(_x)       aich_swap_byteorder_32(_x)
#define oal_high_half_byte(a)       (((a) & 0xF0) >> 4)
#define oal_low_half_byte(a)        ((a) & 0x0F)
#endif

typedef td_u8 oal_mem_state_enum_uint8;
...
typedef struct oal_netbuf_stru_tag {
    ...
    td_u8                       subpool_id        :  4;     /* 记录所属子池id */
    td_u8                       is_high_priority  :  1;
    td_u8                       bit_resv          :  3;
    td_u16                  us_index;
} oal_dev_netbuf_stru;
...
/*****************************************************************************
 ...
 返 回 值  : 成功返回EXT_SUCCESS；失败返回EXT_ERR_CODE_PTR_NULL
*****************************************************************************/
static inline td_u32  oal_netbuf_free(oal_netbuf_stru* netbuf)
{
...
*****************************************************************************/
static inline td_void  oal_netbuf_free_any(oal_netbuf_stru* netbuf)
{
...
/*****************************************************************************
 功能描述  : skb尾部空间扩充
*****************************************************************************/
static inline oal_netbuf_stru* oal_netbuf_realloc_tailroom(oal_netbuf_stru* netbuf, td_u32 tailroom)
{
...
/*****************************************************************************
 ...
 输入参数  : pst_new: 要插入的新skb指针
             ...
             pst_head: skb链表头指针
*****************************************************************************/
static inline td_void  oal_netbuf_add_to_list(oal_netbuf_stru* netbuf, oal_netbuf_stru* prev, oal_netbuf_stru* next)
{
    netbuf->next   = next;
    netbuf->prev   = prev;
    next->prev  = netbuf;
...
/*****************************************************************************
 功能描述  : skb链表从头部入队
*****************************************************************************/
static inline td_void oal_netbuf_addlist(oal_netbuf_head_stru* list_head, oal_netbuf_stru* netbuf)
{
...
/*****************************************************************************
 ...
 输出参数  : The list at @list is reinitialised
*****************************************************************************/
static inline td_void oal_netbuf_splice_sync(oal_netbuf_head_stru* list, oal_netbuf_head_stru* head)
{
...
功能描述: 获取netbuf 链表长度
*****************************************************************************/
static inline td_u32 oal_netbuf_list_len(const oal_netbuf_head_stru *pst_head)
{
...
功能描述: 扩展netbuf 头部空间
*****************************************************************************/
static inline td_s32 oal_netbuf_expand_head(oal_netbuf_stru *netbuf, td_s32 nhead,
                                            td_s32 ntail, td_s32 gfp_mask)
{
