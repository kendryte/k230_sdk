...
/*****************************************************************************
 ...
 返 回 值  :
*****************************************************************************/
static inline oal_workqueue_stru* oal_create_singlethread_workqueue(td_char *pc_workqueue_name)
{
...
/*****************************************************************************
 ...
 返 回 值  :
*****************************************************************************/
static inline td_void oal_destroy_workqueue(oal_workqueue_stru *pst_workqueue)
{
...
/*****************************************************************************
 ...
 返 回 值  :
*****************************************************************************/
static inline td_u32  oal_queue_work(oal_workqueue_stru *pst_workqueue, oal_work_stru *pst_work)
{
 ...
 */
static inline td_u32  oal_queue_delayed_work(oal_workqueue_stru *pst_workqueue,
 ...
 * */
static inline td_u32  oal_queue_delayed_work_on(td_u32 cpu, oal_workqueue_stru *pst_workqueue,
                                                oal_delayed_work *pst_work, unsigned long delay)
{
...
/*****************************************************************************
 ...
 返 回 值  :
*****************************************************************************/
static inline td_u32  oal_queue_delayed_system_work(oal_delayed_work *pst_work, unsigned long delay)
{
