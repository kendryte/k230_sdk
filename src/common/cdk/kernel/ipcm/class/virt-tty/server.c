...
#define VIRT_TTY_SERVER_THREAD    "k_virt-tty_server"
...
extern void *ipcm_vdd_open(int target, int port, int priority);
extern void ipcm_vdd_close(void *data);
extern int ipcm_vdd_sendmsg(void *data,
		const void *buf,
		unsigned int len);
extern int ipcm_vdd_getopt(void *data, struct ipcm_vdd_opt *ops);
extern int ipcm_vdd_setopt(void *data, struct ipcm_vdd_opt *ops);
extern int ipcm_vdd_localid(void);
extern int ipcm_vdd_remoteids(int *ids);
extern void ipcm_vdd_disconnect(void *data);
extern int ipcm_vdd_connect(void *data, int is_block);
extern int ipcm_vdd_check_handle(void *data);
extern int ipcm_vdd_reset_node(int target, int timeout);
extern int ipcm_vdd_node_ready(int target);
