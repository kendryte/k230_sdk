...
class KdMedia {
  public:
    ...
    int GetVbbuffer(k_u32 *pool_id, k_u64 *phys_addr, k_u64 blk_size);
    int ReleaseVbBuffer(k_u64 phys_addr, k_u64 blk_size);
    int PlayCallMusic(int duration_s);
