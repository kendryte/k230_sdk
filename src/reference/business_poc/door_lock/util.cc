...
// void dump_runtime_tensor(std::string &info, runtime_tensor &tensor)
// {
// 	auto &block = static_cast<host_runtime_tensor_impl &>(*tensor.impl()).memory_block();
// 	std::cout << info << ": paddr=" << std::hex << (void *)block.physical_block.physical_address << ", vaddr=" << (void *)block.virtual_address << ", size=" << std::dec << block.size_bytes << std::endl;
// }
